  ...
  return (
    <>
      <CaelumPaper className="staking-lp mx-auto mb-10 w-full md:w-[50%]">
        ...
        <div className="pool-info flex">
          <div className="labels flex grow flex-col">
            <span>Benkei Balance</span>
            <span>Protected Benkei Balance</span>
