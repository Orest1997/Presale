...
function Header(props) {
  ...
  const MAIN_MENU = [
    ...
    {path: "https://docs.benkei.tech", name: "Read the Docs"},
  ...
  return (
    <header className={`header ${authState.preferDark ? "dark-theme" : ""} flex items-center p-5 mx-auto gap-2`}>
      <div className="logo flex-grow" onClick={() => { navigate('/') }}>
        <Link to="/home" className="flex items-center">
          <img src={logo} alt="logo" width="120px" />
          {/* {!isMobileView_1024 && <h2 className="">Benkei</h2>} */}
        </Link>
      </div>
      ...
      <div className="flex gap-2 mx-5">
        <div>
          <a href="https://x.com/Benkeibase" target="_blank">
            <img src={TwitterIcon} alt="twitter icon" width={20}></img>
          </a>
        </div>
        <div>
          <a href="https://t.me/benkeibase" target="_blank">
